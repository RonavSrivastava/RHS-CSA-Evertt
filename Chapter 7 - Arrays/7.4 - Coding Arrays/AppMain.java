public class AppMain {
    ...
    // - Two complete functions (updateDucks & renderDucksToString) using the
    // provided signatures.
    //
    // Example test cases are provided.
    // Examples:
    // Duck[] ducks = { null, null, null, null, null, new MotherDuck(), new Duck(),
    // new Duck(), new Duck(), null, null };
    // Dddd
    // Dddd
    // Dddd
    // Dddd
    ...
    // Dddd
    //
    // Duck[] ducks = { new MotherDuck(), new Duck(), new Duck(), new Duck(), new
    // Duck(), new Duck(), new Duck(), null, null, null, null, null };
    // Ddddddd
    // dddddd D
    // ddddd Dd
    // dddd Ddd
    ...
    private static final int UPDATE_LOOPS = 100;

    public static void main(String[] args) throws InterruptedException {
        // Test cases (remove comments to swap test cases)...
        // Duck[] ducks = { null, null, null, null, null, new MotherDuck(), new Duck(),
        // new Duck(), new Duck(), null,
        // null };
        // Duck[][] ducks = {{new MotherDuck(), new Duck(), new Duck(), new Duck(), new
        // Duck(), new Duck(), new Duck(), null, null, null, null, null}, {null, null,
        ...
        Duck[] ducks = { new Duck(), new Duck(), null, null, null, null, null, null,
                null, null, new MotherDuck(), new Duck() };
    ...
    // Draw the ducks from left to right (BTW - Render is just another way of saying
    // draw).
